...
module.exports = (env, argv) => {
    ...
    return {
        ...
        output: {
            ...
            path: path.resolve(__dirname, "../../../main/resources/WEB/static/dist"),
        ...
        plugins: [
            ...
            new HtmlWebpackPlugin({
                filename: path.resolve("../../main/resources/WEB/static/handicap.html"),
            ...
            new CopyPlugin({
                patterns: [
                  { from: path.resolve("./static"), to: path.resolve("../../main/resources/WEB/static/handicap/") },
                ],
              }),
        ],

...
public class DbMssql implements Serializable, DatabaseBuild {
    ...
    protected enum CreateTable {
        ...
        CREATENAMEIDX(
            "CREATE UNIQUE INDEX USERS_NAME_IDX ON DODEX.USERS (NAME)"),
        CREATEPASSWORDIDX(
            "CREATE UNIQUE INDEX USERS_PASSWORD_IDX ON DODEX.USERS (PASSWORD)"),
        ...
        CREATEUNDELIVERED("create table undelivered (" +
            ...
            "CONSTRAINT undelivered_user_id_foreign FOREIGN KEY (user_id) REFERENCES dodex.users (id)," +
        ...
        CREATEMEMBER("CREATE TABLE member (" +
            ...
            "CONSTRAINT U_fk_MEMBER_USER FOREIGN KEY (USER_ID) REFERENCES dodex.users (ID))"),
        CREATEGOLFER(
          "CREATE TABLE golfer (" +
        ...
        CREATERATINGS(
          "CREATE TABLE ratings (" +
            ...
            "ON UPDATE NO ACTION)"),
        CREATERATINGSIDX(
          "CREATE UNIQUE INDEX COURSE_RATING_IDX ON RATINGS (COURSE_SEQ ASC)"),
        CREATESCORES(
          "CREATE TABLE scores (" +

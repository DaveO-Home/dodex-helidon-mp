...
public class DodexDatabaseMssql extends DodexDatabaseBase implements Serializable {
  ...
  private final static Logger logger = LogManager.getLogger(DodexDatabaseMssql.class.getName());
  ...
  public void entityManagerSetup() {
    if(emf == null) {
      emf = Persistence.createEntityManagerFactory("mssql." + DodexUtil.getMode());
    }

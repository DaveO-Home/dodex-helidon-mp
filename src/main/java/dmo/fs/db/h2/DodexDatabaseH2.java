...
@ApplicationScoped
public class DodexDatabaseH2 extends DodexDatabaseBase implements Serializable {
    @Serial
    private static final long serialVersionUID = 1L;
    private final static Logger logger = LogManager.getLogger(DodexDatabaseH2.class.getName());

    private static EntityManagerFactory emf; //Persistence.createEntityManagerFactory("h2.dev");

    public DodexDatabaseH2() {
        super();
    }
    ...
    public void entityManagerSetup() {
        if (emf == null) {
            emf = Persistence.createEntityManagerFactory("h2." + DodexUtil.getMode());
        }
